...
import CardsAnteseDepois from "../../components/cards/CardAfterAndBefore";
import contentLp01 from "../../content/contentLp01";

export default function TransformationLpi({ colorMode }) {
  // Classes de tema
  const bgClasses = {
    dark: "bg-bgFixedDark",
  ...
  return (
    <SectionArea id="" className={`${bgClass} transition-colors duration-1000`}>
