...
function CardsAnteseDepois({ descriptionBefore, descriptionAfter }) {
  return (
    <div className="flex flex-col items-center desktop1:items-start desktop1:flex-row justify-evenly gap-20 desktop1:gap-0 mt-14">
