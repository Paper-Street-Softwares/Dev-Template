...
export default function FeatureCardLP({ icon, title, description, className }) {
  return (
    <>
      ...
      >
        <div className="h-[64px] w-[64px] mb-[24px] bg-minititle rounded-md flex justify-center items-center text-black">
          {icon}
        </div>
        <h1 className="h-auto leading-[28px] font-bold font-mainFont text-title3 text-center mb-[16px] text-secondary">
          {title}
        </h1>
        <p className="text-center text-black opacity-70 font-mainFont w-full text-paragraph3">
          {description}
        </p>
      </MotionDivDownToUp>
    </>
