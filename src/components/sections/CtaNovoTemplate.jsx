  ...
  return (
    <div className="bg-primary">
      <SectionArea className="relative z-0">
        <div className=" absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/diamond-upholstery.png')] opacity-15 bg-repeat z-0"></div>

        <SectionWrapper className="relative z-10 min-w-full">
          <section className="relative overflow-hidden">
            <div className="container mx-auto px-6 relative z-10 text-center">
              <h2 className="text-4xl md:text-5xl font-mainFont text-white mb-6">
