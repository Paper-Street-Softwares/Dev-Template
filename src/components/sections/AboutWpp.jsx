        ...
        <div className="desktop1:w-[550px] desktop2:w-[570px]">
          <MotionDivDownToUp>
            <SectionHeader
              ...
              miniTitle={content.texts.about.aboutWpp.miniTag}
              sectionHeaderTitle={content.texts.about.aboutWpp.title}
              type="article"
          ...
          <div>
            <Button
              aria-label={content.texts.about.aboutWpp.ariaLabelWhatsApp}
              icon={
                <svg
              ...
              label={content.texts.about.aboutWpp.labelWhatsApp}
              className="mt-4"
            />
          </div>
        </div>
