...
function HeroTemplateNovo() {
  return (
    <SectionArea>
      <section className="relative min-h-[110vh] flex items-center overflow-hidden font-mainFont desktop1:px-[112.5px]">
        ...
        <div className="container relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            className="space-y-8 order-2 lg:order-1 flex flex-col items-center desktop1:items-start"
          >
            ...
            <h2 className="text-center desktop1:text-start text-4xl md:text-5xl lg:text-7xl  font-medium leading-[1.1] text-foreground tracking-tight">
              Atuação{' '}
            ...
            <p className="text-center desktop1:text-start text-lg md:text-xl text-mutedForeground leading-relaxed max-w-lg font-secondFont font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 text-white rounded-full px-8 h-14 text-lg shadow-xl shadow-primary/20 transition-all hover:-translate-y-1 hover:scale-105 group font-secondFont font-medium"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="rounded-full px-8 h-14 text-lg border-primary/20 text-foreground hover:bg-secondary/50 hover:border-primary/40 transition-all font-secondFont font-medium"
              >
            ...
            <div className="flex justify-center desktop1:justify-start items-center gap-3 text-sm text-mutedForeground pt-6 border-t border-border/50 max-w-sm">
              ...
              <span className="font-mainFont font-light">
            ...
            <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl aspect-[3/4] md:aspect-[4/5] lg:aspect-[3/4] border-[8px] border-white ring-1 ring-black/5 bg-gray-100">
              ...
              >
                <div className="flex items-center gap-4 phone3:gap-5">
                  ...
                  <div>
                    <p className="text-paragraph1 phone3:text-xs font-bold text-primary tracking-widest uppercase mb-1">
                      Precisa de ajuda?
                    </p>
                    <p className="text-paragraph2 phone3:text-lg font-serif font-bold text-foreground leading-none">
