        ...
        <Navbar>
          ...
          >
            <img
              ...
              className={`${
                scrolling
                  ? "w-[30%] tablet1:w-[30%] tablet2:w-[20%] desktop1:w-[20%] desktop2:w-[15%] transition-all duration-1000"
                  : "my-[20px] w-[50%] tablet1:w-[40%] tablet2:w-[30%] desktop1:w-[30%] desktop2:w-[20%] transition-all duration-1000"
              } tablet3:mb-0`}
            />
          </ScrollLink>
