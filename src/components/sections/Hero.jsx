...
export default function Hero({
  ...
  const HeroContent = (
    <div className="flex  flex-col w-full desktop1:w-[50%] desktop1:mr-[20px]  ">
      <MotionDivDownToUp>{minititleElement}</MotionDivDownToUp>
      <MotionDivDownToUp>{titleElement}</MotionDivDownToUp>
      <MotionDivDownToUp>{subtitleElement}</MotionDivDownToUp>
      <div className="w-full phone2:w-full tablet2:w-auto">
        <MotionDivDownToUp>{buttonElement}</MotionDivDownToUp>
        <MotionDivDownToUp>{obsHeroElement}</MotionDivDownToUp>
      </div>
    </div>
  );

  let subtitleElementPanoramic;
  let titleElementPanoramic;
  let minititleElementPanoramic;
  ...
  const HeroContentPanoramic = (
    <div className="flex flex-col w-full desktop1:w-[50%] desktop1:mr-[20px]  ">
      ...
      <div className="w-full phone2:w-full tablet2:w-auto">
        <MotionDivDownToUp>{buttonElementPanoramic}</MotionDivDownToUp>
        <MotionDivDownToUp>{obsHeroElementPanoramic}</MotionDivDownToUp>
      </div>
    </div>
  );
  ...
  return (
    ...
    `}
      ...
      {panoramica && (
        <div id="home">
          {/* mobile */}
          <div className="w-full bg-left bg-repeat font-mainFont bg-bgSectionDark desktop1:hidden">
            <div className="relative z-10 flex w-full bg-minititleDarkLabel bg-opacity-0 items-left">
              <div className="w-full text-secondary justify-evenly">
                <div className="h-[100px] tablet1:h-[120px] desktop3:h-[140px]" />
